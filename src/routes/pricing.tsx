...
const plans = [
  {
    name: "GENERATE",
    price: "€9.90",
    cadence: "per completed build",
    note: "For one-off creation without a subscription.",
    featured: false,
    features: ["Prompt Refiner", "AUTO DNA selection", "Standard skin", "Factory presets", "Production Health"],
  },
  {
    name: "GENERATE PRO",
    price: "€19.90",
    cadence: "per completed build",
    note: "For creators who want deeper sound and visual control.",
    featured: true,
    features: ["Full PRO menu", "Advanced Prompt Refiner", "Advanced DSP intent", "Skin variations", "Custom image/vector/logo slots"],
  },
  {
    name: "CREATOR",
    price: "€19.90",
    cadence: "per month",
    note: "PRO access with 3 completed builds each month.",
    featured: false,
    features: ["3 PRO builds / month", "PRO menu", "Preset tools", "Skin tools", "Priority queue"],
  },
  {
    name: "STUDIO",
    price: "€39.90",
    cadence: "per month",
    note: "For regular creation with 8 completed builds each month.",
    featured: false,
    features: ["8 PRO builds / month", "PRO menu", "Advanced skin workflow", "Preset pack tools", "Commercial workflow"],
  },
  {
    name: "WARLOCK PRO",
    price: "€69.90",
    cadence: "per month",
    note: "For high-volume professional creation with 16 completed builds.",
    featured: false,
    features: ["16 PRO builds / month", "Advanced audio controls", "Custom branding slots", "Priority builds", "Professional support"],
  },
];
  ...
  return (
    <main className="warlock-app-page warlock-page-enter">
      <header className="warlock-app-header">
        <Link to="/" className="warlock-app-brand"><img src="/brand/warlock-core.svg" alt="" /><span><strong>WARLOCK</strong><small>PRICING</small></span></Link>
        <nav><Link to="/">Home</Link><Link to="/generate">Generate</Link><Link to="/pricing" className="is-active">Pricing</Link><Link to="/support">Support</Link></nav>
